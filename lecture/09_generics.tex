...
The call to the (generic) function \texttt{distance}, i.e. the \emph{instantiation} of that function with a concrete type, is
...
\texttt{class}, it is declared with any integral value type, e.g. \cpp{int}.
...
instantiated template parameters, e.g. \cpp{mypoint<double>} $\Rightarrow$ \texttt{[...]mypointId[...]} (in g++)
