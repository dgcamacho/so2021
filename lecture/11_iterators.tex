...
The second variant of copy, \cpp{std::copy_if}, expects an additional function parameter representing a \emph{unary predicate}, i.\,e.\ function or functor
...
methods have a different effect as expected, essentially they do nothing, but, in case of the dereference operator, just return \cpp{*this}, i.\,e.\ a reference
