...
\begin{rem}
  With \marginpar{[\cxx{20}]}\cxx{20} one can introduce named template parameters in generic lambdas. Therefore, one adds after the capture
  block in the lambda definition a declaration of template parameters:
  %
  \begin{minted}{c++}
