...
If a function has a return type unequal to \cpp{void}, it needs a \cpp{return} statement, unless it never returns. Void-functions can omit this statement, but are allowed to
