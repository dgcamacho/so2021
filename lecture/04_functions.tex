...
are some pitfalls, see below). But, you can also return a value, by providing an additional \emph{output argument}, e.g.
%
...
\begin{example}
  ...
  \end{minted}
  %
  This overload-set generates a compiler error, since (0) is equivalent to (1) or (2), i.e. all three are exact matches. Removing (0) resolves this error.
